...
hooks = {
    ...
    'SIGNAL': [os.environ['SIGNAL_HOOK']],
}

CHANNELS = {
    # bc sniper
    '917568228367171614': {
        'description': "TA-eazy12k",
        'hooks': hooks['TA']
    },
    '912549044805566584': {
        'description': "TA-pulkit",
        'hooks': hooks['TA']
    },
    '912549119023792128': {
        'description': "TA-asad",
    ...
    '914234223248932894': {
        'description': "TA-surja",
        'hooks': hooks['TA']
    },
    '945769733729452122': {
        'description': "TA-moussa",
        'hooks': hooks['TA']
    },
    '957322015671484456': {
        'description': "TA-lucifer",
        'hooks': hooks['TA']
    },
    '966717040989708398': {
        'description': "TA-kayler",
        'hooks': hooks['TA']
    },
    '996773096587526225': {
        'description': "TA-kingpincrypto",
        'hooks': hooks['TA']
    },
    '970807197758005298': {
    ...
    '938996765921792050': {
        'description': "TR-lesson",
        'hooks': hooks['TR']
    },
    '898579005232521286': {
        'description': "DAILY-BTC",
        'hooks': hooks['DAILY']
    },
    '899394668662505502': {
        'description': "DAILY-ETH",
        'hooks': hooks['DAILY']
    },
    '930970372726222898': {
...
# for m in reversed(bot.getMessages('970807236203003905', num=9, beforeDate='1021783221861617745').json()):
#     channelID = m["channel_id"]
#     content = m["content"]
#     wb = get_ori_webhook(channelID)
#     if wb:
